...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Provider "microsoft-windows-palloc" event count 2
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

// Provider GUID = 138f4dbb-ee04-4899-aa0a-572ad4475779
EXTERN_C __declspec(selectany) const GUID ETW_PALLOC_Provider = {0x138f4dbb, 0xee04, 0x4899, {0xaa, 0x0a, 0x57, 0x2a, 0xd4, 0x47, 0x57, 0x79}};

#ifndef ETW_PALLOC_Provider_Traits
#define ETW_PALLOC_Provider_Traits NULL
#endif // ETW_PALLOC_Provider_Traits

//
// Event Descriptors
//
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR ETW_PALLOC_ALLOC = {0x64, 0x1, 0x0, 0x4, 0x0, 0x0, 0x0};
#define ETW_PALLOC_ALLOC_value 0x64
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR ETW_PALLOC_FREE = {0x65, 0x1, 0x0, 0x4, 0x0, 0x0, 0x0};
#define ETW_PALLOC_FREE_value 0x65
...
//
EXTERN_C __declspec(selectany) DECLSPEC_CACHEALIGN ULONG microsoft_windows_pallocEnableBits[1];
EXTERN_C __declspec(selectany) const ULONGLONG microsoft_windows_pallocKeywords[1] = {0x0};
EXTERN_C __declspec(selectany) const unsigned char microsoft_windows_pallocLevels[1] = {4};

//
// Provider context
//
EXTERN_C __declspec(selectany) MCGEN_TRACE_CONTEXT ETW_PALLOC_Provider_Context = {0, (ULONG_PTR)ETW_PALLOC_Provider_Traits, 0, 0, 0, 0, 0, 0, 1, microsoft_windows_pallocEnableBits, microsoft_windows_pallocKeywords, microsoft_windows_pallocLevels};

//
// Provider REGHANDLE
//
#define microsoft_windows_pallocHandle (ETW_PALLOC_Provider_Context.RegistrationHandle)
...
//
#define ETW_PALLOC_Provider_EventWriteActivity 0
...
//
#ifndef EventRegistermicrosoft_windows_palloc
#define EventRegistermicrosoft_windows_palloc() McGenEventRegister(&ETW_PALLOC_Provider, McGenControlCallbackV2, &ETW_PALLOC_Provider_Context, &microsoft_windows_pallocHandle)
#endif
...
//
#ifndef EventRegisterByGuidmicrosoft_windows_palloc
#define EventRegisterByGuidmicrosoft_windows_palloc(Guid) McGenEventRegister(&(Guid), McGenControlCallbackV2, &ETW_PALLOC_Provider_Context, &microsoft_windows_pallocHandle)
#endif
...
//
#ifndef EventUnregistermicrosoft_windows_palloc
#define EventUnregistermicrosoft_windows_palloc() McGenEventUnregister(&microsoft_windows_pallocHandle)
#endif
...
// - Caller allocates memory, e.g. pContext = malloc(sizeof(McGenContext_microsoft_windows_palloc));
// - Caller registers the provider, e.g. EventRegistermicrosoft_windows_palloc_ForContext(pContext);
// - Caller writes events, e.g. EventWriteMyEvent_ForContext(pContext, ...);
// - Caller unregisters, e.g. EventUnregistermicrosoft_windows_palloc_ForContext(pContext);
// - Caller frees memory, e.g. free(pContext);
//

typedef struct tagMcGenContext_microsoft_windows_palloc {
    // The fields of this structure are subject to change and should
    // not be accessed directly. To access the provider's REGHANDLE,
    // use microsoft_windows_pallocHandle_ForContext(pContext).
    MCGEN_TRACE_CONTEXT Context;
    ULONG EnableBits[1];
} McGenContext_microsoft_windows_palloc;

#define EventRegistermicrosoft_windows_palloc_ForContext(pContext)             _mcgen_PASTE2(_mcgen_RegisterForContext_microsoft_windows_palloc_, MCGEN_EVENTREGISTER)(&ETW_PALLOC_Provider, pContext)
#define EventRegisterByGuidmicrosoft_windows_palloc_ForContext(Guid, pContext) _mcgen_PASTE2(_mcgen_RegisterForContext_microsoft_windows_palloc_, MCGEN_EVENTREGISTER)(&(Guid), pContext)
#define EventUnregistermicrosoft_windows_palloc_ForContext(pContext)           McGenEventUnregister(&(pContext)->Context.RegistrationHandle)

//
// Provider REGHANDLE for caller-allocated context.
//
#define microsoft_windows_pallocHandle_ForContext(pContext) ((pContext)->Context.RegistrationHandle)

// This function is for use by MC-generated code and should not be used directly.
// Initialize and register the caller-allocated context.
__inline
ULONG __stdcall
_mcgen_PASTE2(_mcgen_RegisterForContext_microsoft_windows_palloc_, MCGEN_EVENTREGISTER)(
    _In_ LPCGUID pProviderId,
    _Out_ McGenContext_microsoft_windows_palloc* pContext)
{
    RtlZeroMemory(pContext, sizeof(*pContext));
    pContext->Context.Logger = (ULONG_PTR)ETW_PALLOC_Provider_Traits;
    pContext->Context.EnableBitsCount = 1;
    pContext->Context.EnableBitMask = pContext->EnableBits;
    pContext->Context.EnableKeyWords = microsoft_windows_pallocKeywords;
    pContext->Context.EnableLevel = microsoft_windows_pallocLevels;
...
FORCEINLINE
_Ret_ McGenContext_microsoft_windows_palloc*
_mcgen_CheckContextType_microsoft_windows_palloc(_In_ McGenContext_microsoft_windows_palloc* pContext)
{
    return pContext;
}
...
//
// Enablement check macro for event "ETW_PALLOC_ALLOC"
//
#define EventEnabledETW_PALLOC_ALLOC() _mcgen_EVENT_BIT_SET(microsoft_windows_pallocEnableBits, 0)
#define EventEnabledETW_PALLOC_ALLOC_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_microsoft_windows_palloc(pContext)->EnableBits, 0)

//
// Event write macros for event "ETW_PALLOC_ALLOC"
//
#define EventWriteETW_PALLOC_ALLOC(Address, Size) \
        MCGEN_EVENT_ENABLED(ETW_PALLOC_ALLOC) \
        ? _mcgen_TEMPLATE_FOR_ETW_PALLOC_ALLOC(&ETW_PALLOC_Provider_Context, &ETW_PALLOC_ALLOC, Address, Size) : 0
#define EventWriteETW_PALLOC_ALLOC_AssumeEnabled(Address, Size) \
        _mcgen_TEMPLATE_FOR_ETW_PALLOC_ALLOC(&ETW_PALLOC_Provider_Context, &ETW_PALLOC_ALLOC, Address, Size)
#define EventWriteETW_PALLOC_ALLOC_ForContext(pContext, Address, Size) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, ETW_PALLOC_ALLOC) \
        ? _mcgen_TEMPLATE_FOR_ETW_PALLOC_ALLOC(&(pContext)->Context, &ETW_PALLOC_ALLOC, Address, Size) : 0
#define EventWriteETW_PALLOC_ALLOC_ForContextAssumeEnabled(pContext, Address, Size) \
        _mcgen_TEMPLATE_FOR_ETW_PALLOC_ALLOC(&_mcgen_CheckContextType_microsoft_windows_palloc(pContext)->Context, &ETW_PALLOC_ALLOC, Address, Size)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_ETW_PALLOC_ALLOC _mcgen_PASTE2(McTemplateU0xx_, MCGEN_EVENTWRITETRANSFER)

//
// Enablement check macro for event "ETW_PALLOC_FREE"
//
#define EventEnabledETW_PALLOC_FREE() _mcgen_EVENT_BIT_SET(microsoft_windows_pallocEnableBits, 0)
#define EventEnabledETW_PALLOC_FREE_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_microsoft_windows_palloc(pContext)->EnableBits, 0)

//
// Event write macros for event "ETW_PALLOC_FREE"
//
#define EventWriteETW_PALLOC_FREE(Address, Size) \
        MCGEN_EVENT_ENABLED(ETW_PALLOC_FREE) \
        ? _mcgen_TEMPLATE_FOR_ETW_PALLOC_FREE(&ETW_PALLOC_Provider_Context, &ETW_PALLOC_FREE, Address, Size) : 0
#define EventWriteETW_PALLOC_FREE_AssumeEnabled(Address, Size) \
        _mcgen_TEMPLATE_FOR_ETW_PALLOC_FREE(&ETW_PALLOC_Provider_Context, &ETW_PALLOC_FREE, Address, Size)
#define EventWriteETW_PALLOC_FREE_ForContext(pContext, Address, Size) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, ETW_PALLOC_FREE) \
        ? _mcgen_TEMPLATE_FOR_ETW_PALLOC_FREE(&(pContext)->Context, &ETW_PALLOC_FREE, Address, Size) : 0
#define EventWriteETW_PALLOC_FREE_ForContextAssumeEnabled(pContext, Address, Size) \
        _mcgen_TEMPLATE_FOR_ETW_PALLOC_FREE(&_mcgen_CheckContextType_microsoft_windows_palloc(pContext)->Context, &ETW_PALLOC_FREE, Address, Size)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_ETW_PALLOC_FREE _mcgen_PASTE2(McTemplateU0xx_, MCGEN_EVENTWRITETRANSFER)
