...
vcpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS
  FEATURES
    c           PALLOC_NO_USE_CXX
    guarded     PALLOC_GUARDED
    secure      PALLOC_SECURE
    override    PALLOC_OVERRIDE
    optarch     PALLOC_OPT_ARCH
    nooptarch   PALLOC_NO_OPT_ARCH
    optsimd     PALLOC_OPT_SIMD
    xmalloc     PALLOC_XMALLOC
    asm         PALLOC_SEE_ASM
)
string(COMPARE EQUAL "${VCPKG_LIBRARY_LINKAGE}" "static" PALLOC_BUILD_STATIC)
string(COMPARE EQUAL "${VCPKG_LIBRARY_LINKAGE}" "dynamic" PALLOC_BUILD_SHARED)
...
vcpkg_cmake_configure(
  ...
  OPTIONS
    ...
    -DMI_BUILD_TESTS=OFF
    -DMI_BUILD_OBJECT=ON
    -DMI_BUILD_STATIC=${PALLOC_BUILD_STATIC}
    -DMI_BUILD_SHARED=${PALLOC_BUILD_SHARED}
...
if(VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
  ...
  vcpkg_replace_string(
    ...
    "!defined(PALLOC_SHARED_LIB)"
    "0 // !defined(PALLOC_SHARED_LIB)"
  )
endif()
